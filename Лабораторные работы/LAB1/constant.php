...
*/
    if (defined("Something") == true){
        echo "Константа существует, её значение: ".constant("Something")."<br/>";
    } else {
        echo "Константы не существует";
    }

    echo "Версия PHP: ".PHP_VERSION."<br/> Директория: ".__DIR__;
